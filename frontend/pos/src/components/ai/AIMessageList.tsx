  ...
  if (!messages.length && !isLoading) {
    return (
      <div className="flex min-h-[320px] flex-col items-center justify-center gap-4 px-4 py-10 text-center">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-50 to-cyan-100 shadow-sm">
          <Bot aria-hidden="true" className="h-7 w-7 text-cyan-600" />
        </div>
        ...
        <div className="flex justify-start animate-fade-in">
          <div className="inline-flex items-center gap-2.5 rounded-2xl border border-slate-200/80 bg-white px-4 py-3 text-sm font-semibold text-slate-500 shadow-sm">
            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-cyan-100">
              <Loader2 aria-hidden="true" className="h-3.5 w-3.5 animate-spin text-cyan-600" />
            </div>
