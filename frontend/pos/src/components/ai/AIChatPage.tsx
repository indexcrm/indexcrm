  ...
  if (!user) {
    return (
      <div className="grid gap-5">
        ...
        />
        <section className="rounded-2xl border border-slate-700/30 bg-[#131b2e] p-6 text-sm font-semibold text-slate-400 shadow-sm">
  ...
  return (
    <div className="grid gap-5">
      <SectionHeader
        ...
        actions={
          <button
            ...
            className="inline-flex h-9 items-center gap-2 rounded-xl border border-slate-700/30 bg-[#131b2e] px-3.5 text-xs font-bold text-slate-300 shadow-sm hover:bg-blue-900/20 hover:border-blue-200 hover:text-blue-300 active:scale-95 transition-all"
          >
      ...
      <div className="grid gap-4 xl:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <section className="grid min-h-[calc(100vh-12rem)] overflow-hidden rounded-2xl border border-slate-700/30 bg-[#131b2e] shadow-sm">
          <div className="flex min-h-0 flex-col">
            <div className="flex items-center justify-between gap-3 border-b border-slate-700/30 px-4 py-3 bg-[#0f172a]/80">
            ...
            <div className="grid gap-3 border-t border-slate-700/30 bg-[#131b2e] p-3 sm:p-4">
              {error ? (
