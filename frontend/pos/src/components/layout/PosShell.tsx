...
export function PosShell({ children }: PosShellProps) {
  ...
  return (
    <main className="h-screen overflow-hidden bg-[#0b1120] text-slate-100 flex flex-col">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-tight text-white">
              ...
              <span className="text-cyan-400 font-light ml-1">POS</span>
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-2">
            <span className="rounded-lg bg-cyan-500/10 px-2 py-0.5 text-[9px] font-black tracking-widest text-cyan-400 border border-cyan-400/20 uppercase shadow-sm">
              Kassir
            </span>
          </div>
        </div>
        <div className="flex items-center gap-4 text-sm font-medium">
          <div className="hidden items-center gap-3 text-slate-500 lg:flex">
            {cashierName || cashierEmail ? (
              <div className="flex items-center gap-2">
                <div className="h-6 w-6 rounded-full bg-gradient-to-br from-cyan-400 to-cyan-600 flex items-center justify-center text-[10px] font-bold text-white shadow-sm">
