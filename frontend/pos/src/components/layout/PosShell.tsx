        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-tight text-white">
              ...
              <span className="text-teal-400 font-light ml-1">POS</span>
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-2">
            <span className="rounded-lg bg-teal-500/10 px-2 py-0.5 text-[9px] font-black tracking-widest text-teal-400 border border-teal-400/20 uppercase shadow-sm">
              Kassir
            </span>
          </div>
        </div>
        <div className="flex items-center gap-4 text-sm font-medium">
          <div className="hidden items-center gap-3 text-slate-400 lg:flex">
            {cashierName || cashierEmail ? (
              <div className="flex items-center gap-2">
                <div className="h-6 w-6 rounded-full bg-gradient-to-br from-teal-400 to-teal-600 flex items-center justify-center text-[10px] font-bold text-white shadow-sm">
