...
export function DashboardOverview() {
  ...
  return (
    <div className="grid gap-5">
      <div className="rounded-2xl border border-rose-100/50 bg-gradient-to-br from-white to-rose-50/30 p-5 shadow-soft">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-500 to-rose-600 text-white shadow-lg shadow-rose-500/15">
