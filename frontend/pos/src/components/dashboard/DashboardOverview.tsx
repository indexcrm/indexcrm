...
export function DashboardOverview() {
  ...
  return (
    <div className="grid gap-5">
      <div className="rounded-2xl border border-yellow-100/50 bg-gradient-to-br from-white to-yellow-50/30 p-5 shadow-soft">
        <div className="flex items-center gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-yellow-500 to-yellow-600 text-white shadow-lg shadow-yellow-500/15">
