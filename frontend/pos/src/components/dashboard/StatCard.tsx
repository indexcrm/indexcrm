...
const toneClasses = {
  red: "from-red-50/80 to-red-100/20 border-red-200/40",
  ...
  slate: "from-slate-50/80 to-red-50/20 border-red-100/40",
};

const iconBgClasses = {
  red: "bg-gradient-to-br from-red-600 to-red-800 text-white shadow-lg shadow-red-600/15 ring-1 ring-white/20",
  ...
  slate: "bg-gradient-to-br from-red-600 to-red-800 text-white shadow-lg shadow-red-600/15 ring-1 ring-white/20",
};
