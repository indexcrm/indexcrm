...
type StatCardProps = {
  ...
  description?: string;
  icon: LucideIcon;
  tone?: "coral" | "rose" | "amber" | "orange" | "slate";
};

const toneClasses = {
  coral: "from-rose-50/80 to-orange-50/20 border-rose-200/40",
  ...
  slate: "from-slate-50/80 to-rose-50/20 border-rose-100/40",
};

const iconBgClasses = {
  coral: "bg-gradient-to-br from-rose-500 to-orange-500 text-white shadow-lg shadow-rose-500/15 ring-1 ring-white/20",
  ...
  slate: "bg-gradient-to-br from-rose-500 to-orange-500 text-white shadow-lg shadow-rose-500/15 ring-1 ring-white/20",
};
