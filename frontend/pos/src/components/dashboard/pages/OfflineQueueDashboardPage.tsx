  ...
  return (
    <div className="grid gap-5">
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex min-h-10 items-center gap-2 rounded border border-teal-100/50 bg-white px-3 text-sm font-black text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
            >
      ...
      {actionNotice || lastResult ? (
        <div className="rounded-xl border border-teal-100/40 bg-white px-4 py-3 text-sm font-bold text-slate-700 shadow-soft">
          {actionNotice ||
            (lastResult
      ...
      {syncEvents.length > 0 ? (
        <section className="rounded border border-teal-100/40 bg-white shadow-soft">
          <div className="border-b border-teal-100/40 px-4 py-3">
      ...
      <section className="rounded border border-teal-100/40 bg-white shadow-soft">
        <div className="flex flex-col gap-3 border-b border-teal-100/40 px-4 py-3 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-wrap gap-2">
            {filters.map((item) => (
              <button
                key={item.value}
          ...
          <select
            ...
            className="h-10 rounded border border-teal-100/50 bg-white px-3 text-sm font-black text-slate-700"
          >
      ...
      {selectedSale ? (
        <section className="rounded border border-teal-100/40 bg-white shadow-soft">
          <div className="flex flex-col gap-3 border-b border-teal-100/40 px-4 py-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="inline-flex min-h-10 items-center gap-2 rounded border border-teal-100/50 bg-white px-3 text-sm font-black text-slate-700 hover:bg-slate-50"
              >
          ...
          <div className="grid gap-4 p-4 lg:grid-cols-[1fr_1fr]">
            ...
            <div className="grid gap-3 rounded-xl border border-teal-100/40 bg-teal-50/30 p-4">
              <DetailRow
                label="Lokal havola"
