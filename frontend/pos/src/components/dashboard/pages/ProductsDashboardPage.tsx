    ...
    <div className="grid gap-5">
        ...
        actions={
          <div className="flex flex-col gap-2 sm:flex-row">
            <input
              ...
              className="h-11 rounded-xl border border-yellow-100/50 px-3.5 font-semibold shadow-soft"
            />
            <IconButton
              type="button"
      ...
      {form ? (
        <form
          ...
          className="rounded-xl border border-yellow-100/40 bg-white p-5 shadow-soft"
        >
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <label className="grid gap-1 text-sm font-bold text-slate-700">
              ...
              <input
                ...
                className="h-11 rounded-xl border border-yellow-100/50 px-3.5 shadow-soft"
              />
            </label>
            <label className="grid gap-1 text-sm font-bold text-slate-700">
              Kategoriya
              <select
                ...
                className="h-11 rounded-xl border border-yellow-100/50 bg-white px-3.5 shadow-soft"
              >
        ...
        <div className="rounded border border-yellow-200 bg-yellow-50 px-3 py-2 text-sm font-bold text-yellow-900">
          {formMessage}
        </div>
      ) : null}
      <DataTable
