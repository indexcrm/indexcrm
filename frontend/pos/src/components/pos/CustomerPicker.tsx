...
export function CustomerPicker({
  ...
  return (
    <section className="border-b border-slate-200/80 bg-white p-4">
      ...
      {selectedCustomer ? (
        <div className="rounded-xl border border-violet-200/70 bg-gradient-to-br from-violet-50 to-violet-50/30 p-3.5 shadow-sm">
          <div className="font-bold text-violet-950 text-sm">
