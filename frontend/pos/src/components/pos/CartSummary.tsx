  ...
  return (
    <section className="no-print border-t border-slate-200/80 bg-gradient-to-b from-white to-slate-50/50 p-4">
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <div className="rounded-xl border border-purple-200/80 bg-gradient-to-br from-purple-50 to-purple-50/50 p-3 shadow-sm ring-1 ring-purple-200/50">
          <div className="text-[10px] font-black uppercase tracking-wider text-purple-600">
            Jami
          </div>
          <div className="text-2xl font-black text-purple-800 mt-0.5">
            {formatMoney(total)}
          </div>
        </div>
      </div>
