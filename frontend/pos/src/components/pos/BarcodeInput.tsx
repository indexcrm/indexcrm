    ...
    <form onSubmit={handleSubmit} className="flex gap-2">
      <div className="relative flex-1 group">
        ...
        <input
          ...
          inputMode="search"
          className="h-18 w-full rounded-2xl border-0 bg-white pl-14 pr-20 text-2xl font-black tracking-wider text-slate-900 shadow-lg shadow-slate-200/50 ring-1 ring-inset ring-slate-200 transition-all duration-200 placeholder:text-slate-400 placeholder:font-medium focus:ring-2 focus:ring-inset focus:ring-blue-500 focus:shadow-xl focus:shadow-blue-500/10 outline-none"
        />
        <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
          <span className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-slate-50/80 px-2.5 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-widest shadow-sm">
            <kbd className="bg-slate-200 rounded px-1 py-0.5 text-slate-500">F2</kbd>
