...
const tones = {
  neutral: "border-teal-100/50 bg-white text-slate-700 hover:bg-teal-50 hover:border-teal-200 shadow-soft",
  primary: "border-teal-600 bg-teal-600 text-white hover:bg-teal-700 hover:shadow-md shadow-soft",
