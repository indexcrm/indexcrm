...
const tones = {
  neutral: "border-amber-100/50 bg-white text-slate-700 hover:bg-amber-50 hover:border-amber-200 shadow-soft",
  primary: "border-amber-600 bg-amber-600 text-white hover:bg-amber-700 hover:shadow-md shadow-soft",
