...
const tones = {
  neutral: "border-violet-100/50 bg-white text-slate-700 hover:bg-violet-50 hover:border-violet-200 shadow-soft",
  primary: "border-violet-600 bg-violet-600 text-white hover:bg-violet-700 hover:shadow-md shadow-soft",
  danger: "border-rose-600 bg-rose-600 text-white hover:bg-rose-700 hover:shadow-md shadow-soft",
  success: "border-violet-600 bg-violet-600 text-white hover:bg-violet-700 hover:shadow-md shadow-soft",
