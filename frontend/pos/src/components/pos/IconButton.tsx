...
const tones = {
  neutral: "border-yellow-100/50 bg-white text-slate-700 hover:bg-yellow-50 hover:border-yellow-200 shadow-soft",
  primary: "border-yellow-600 bg-yellow-600 text-white hover:bg-yellow-700 hover:shadow-md shadow-soft",
  danger: "border-rose-600 bg-rose-600 text-white hover:bg-rose-700 hover:shadow-md shadow-soft",
  success: "border-yellow-600 bg-yellow-600 text-white hover:bg-yellow-700 hover:shadow-md shadow-soft",
