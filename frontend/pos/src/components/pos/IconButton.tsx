...
const tones = {
  neutral: "border-blue-100/50 bg-white text-slate-700 hover:bg-blue-50 hover:border-blue-200 shadow-soft",
  primary: "border-blue-600 bg-blue-600 text-white hover:bg-blue-700 hover:shadow-md shadow-soft",
  danger: "border-rose-600 bg-rose-600 text-white hover:bg-rose-700 hover:shadow-md shadow-soft",
  success: "border-blue-600 bg-blue-600 text-white hover:bg-blue-700 hover:shadow-md shadow-soft",
