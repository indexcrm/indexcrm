  ...
  return (
    <section className="no-print border-b border-slate-200/80 bg-white p-4">
      <div className="mb-2 flex items-center gap-2 text-xs font-black uppercase tracking-wider text-slate-500">
        <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-rose-600 to-rose-700 text-white shadow-sm">
      ...
      >
        <div className={`flex h-5 w-5 items-center justify-center rounded-full ${
          canComplete ? "bg-rose-200/60" : "bg-amber-200/60"
        }`}>
          {canComplete ? (
      ...
      <IconButton
        ...
        className="mt-3 h-14 w-full text-sm font-bold rounded-xl shadow-lg shadow-rose-500/20"
      />
    </section>
  );
}
